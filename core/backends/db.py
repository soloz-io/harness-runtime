"""DBBackend: StateBackend + DB-backed cross-session file operations.
...
class DBBackend(StateBackend):
    ...
    def _query_db(self, path: str) -> tuple | None:
        ...
        try:
            ...
            logger.exception("db_backend_read_failed", path=path)
            return None
    ...
    def _query_db_ls(self, path: str) -> list[FileInfo]:
        ...
        try:
            ...
            logger.exception("db_backend_ls_failed", path=path)
            return []
    ...
    def _query_db_filepaths(self) -> list[str]:
        ...
        try:
            ...
            logger.exception("db_backend_filepaths_failed")
            return []
    ...
    def _query_db_grep(
        ...
        try:
            ...
            logger.exception("db_backend_grep_failed", pattern=pattern)
            return []
